...
class DialogCastEditor extends Editor {	
			...
			EditorGUILayout.BeginHorizontal();
				...
				EditorGUILayout.BeginVertical();
					...
					if(!Application.isPlaying){
						GUILayout.Label("Optional Library to quickly setup actors, portraits and icons in Dialog Screens.", GUILayout.MinWidth(450), GUILayout.MaxWidth(450));
					} else {
	...
	function DrawActorGroup( dca : DialogCastGroup ){
		...
		EditorGUILayout.BeginHorizontal();
			...
			dca.name = EditorGUILayout.TextField("Cast / Group Name:", dca.name );
			GUILayout.Label("", GUILayout.MaxWidth(5)); // indent
		EditorGUILayout.EndHorizontal();
